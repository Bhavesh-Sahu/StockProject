# -*- coding: utf-8 -*-
"""
Created on Sat Oct 10 16:48:59 2020
...
fb = get_adj_close('hindunilvr.ns', '1/2/2018', '9/10/2020')
...
fig=fb[['Adj Close', '30 Day MA', 'Upper Band', 'Lower Band']].plot(figsize=(12,6))
...
Html_file= open("hindunilvr.html","w")
